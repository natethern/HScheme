...
module Org.Org.Semantic.HScheme.Equality where
	...
	sameList	:: (Scheme m r,?objType :: Type (Object r m)) => 
	...
	sameSRefArray	:: (Scheme m r,?objType :: Type (Object r m)) => 
	...
	equal :: (Scheme m r,?objType :: Type (Object r m)) => 
	...
	eqv :: (FullScheme m r,?objType :: Type (Object r m)) => 
	 Object r m -> Object r m -> m Bool;
	...
	eqvP ::  (FullScheme m r,?objType :: Type (Object r m)) => 
	 (Object r m,(Object r m,())) -> m Bool;
	eqvP (a,(b,())) = eqv a b;

	equalP ::  (Scheme m r,?objType :: Type (Object r m)) => 
	 (Object r m,(Object r m,())) -> m Bool;
